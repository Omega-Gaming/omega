...
import navbarTitle from "../images/navbarTitle.png";
import { Link } from "react-router-dom";
const Navbar = () => {
  let toggle = React.createRef();
  let navbarMenu = React.createRef();
  let socialIcons = React.createRef();

  let menuToggle = () => {
    toggle.current.classList.toggle("change");
    navbarMenu.current.classList.toggle("hidden");
    socialIcons.current.classList.toggle("hidden");
  };
  return (
    <div className="navbar">
      <div className="navbar-header">
        <img src={navbarLogo} alt="" className="navbar-logo" />
        <img src={navbarTitle} alt="" className="navbar-title" />
        <div className="navbar-mobile change" onClick={menuToggle} ref={toggle}>
      ...
      <div className="navbar-menu" ref={navbarMenu}>
        ...
        <Link className="nav-item-link" to="/uniswap">
          <div className="nav-item">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
        ...
        <Link className="nav-item-link" to="treasury">
          <div className="nav-item">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
              className="treasury icon"
            >
      ...
      <div className="navbar-social-icons" ref={socialIcons}>
        ...
        <div className="navbar-social-icon discord">
        ...
        <div className="navbar-social-icon telegram">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
